...
public class CommutativeMonoidAlgoSolverMeta extends BaseCMonoidAlgoSolverMeta {
  @Dependency
  ArendRef CMonoidSolverModel;
  @Dependency
  CoreClassDefinition CMonoid;
  @Dependency(name = "Pointed.ide")
  CoreClassField ide;
