...
public class AbelianMonoidAlgoSolverMeta extends BaseCMonoidAlgoSolverMeta {
  @Dependency
  ArendRef AbMonoidSolverModel;
  @Dependency
  CoreClassDefinition AbMonoid;
  @Dependency(name = "AddPointed.zro")
  CoreClassField zro;
