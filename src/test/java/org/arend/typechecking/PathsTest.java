...
public class PathsTest extends TypeCheckingTestCase {
  ...
  public void idpUntyped() {
    ...
    assertEquals(Pi(A, Pi(a, FunCall(Prelude.PATH_INFIX, Levels.EMPTY, Ref(A), Ref(a), Ref(a)))).normalize(NormalizationMode.NF), idp.type.normalize(NormalizationMode.NF));
  }
