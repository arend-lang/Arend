...
open class ArendStarterLibrariesStep(contextProvider: ArendStarterContextProvider) : ModuleWizardStep() {
    ...
    protected val moduleBuilder: ArendStarterModuleBuilder = contextProvider.moduleBuilder
                ...
                cell(JPanel(GridBagLayout()).apply {
                    ...
                    add(JPanel(GridBagLayout()).apply {
                        ...
                        add(BorderLayoutPanel().apply {
                            ...
                            addToTop(
                                JBLabel(messages?.selectedDependenciesLabel
    ...
    fun getSelectedLibraries(): MutableList<LibraryInfo> {
