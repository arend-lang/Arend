...
class InteractiveGoalSolverQuickFix(private val element: ArendExpr,
    ...
    override fun invoke(project: Project, editor: Editor, file: PsiFile?) {
        invokeLater {
            solver.solve(CheckTypeVisitor.loadTypecheckingContext(goal.typecheckingContext, DummyErrorReporter.INSTANCE), goal.goalExpression, goal.expectedType, ArendEditorUI(project, editor)) {
                if (it != null) {
