...
class ArendCaseExpr(node: ASTNode) : ArendExpr(node), Abstract.CaseArgumentsHolder {
    ...
    override fun <P : Any?, R : Any?> accept(visitor: AbstractExpressionVisitor<in P, out R>, params: P?): R {
        ...
        return visitor.visitCase(this, caseKw?.elementType == SCASE_KW, evalKind, caseArguments, returnExpr?.type, returnExpr?.typeLevel, returnExpr?.isLevelPlus == true, withBody?.clauseList ?: emptyList(), params)
    }
}