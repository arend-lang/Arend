...
val AREND_DOC_TOKENS: TokenSet = TokenSet.create(DOC_SINGLE_LINE_START, DOC_START, DOC_END, DOC_INLINE_CODE_BORDER,
    ...
    DOC_REFERENCE, DOC_REFERENCE_TEXT, DOC_LINK, DOC_LINK_TEXT, DOC_OPEN_LINK, DOC_INLINE_LATEX_CODE, DOC_NEWLINE_LATEX_CODE, DOC_LATEX_CODE,
    DOC_ITALICS_CODE_BORDER, DOC_ITALICS_CODE, DOC_BOLD_CODE_BORDER, DOC_BOLD_CODE, DOC_NEWLINE, DOC_NEXT_LINE, DOC_LINEBREAK, DOC_TABS,
