...
val BASIC_EXPRESSION_KW = listOf(PI_KW, SIGMA_KW, SIGMA_PLUS_KW, LAM_KW, HAVE_KW, HAVES_KW, LET_KW, LETS_KW, CASE_KW, SCASE_KW).map { it.toString() }
...
val FIELD_KW_LIST = listOf(FIELD_KW.toString())
