...
public interface AbstractExpressionVisitor<P, R> {
  ...
  R visitFieldAccs(@Nullable Object data, @NotNull Abstract.Expression expression, @NotNull List<Abstract.FieldAcc> fieldAccs, @Nullable AbstractReference infixReference, @Nullable String infixName, boolean isInfix, P params);
