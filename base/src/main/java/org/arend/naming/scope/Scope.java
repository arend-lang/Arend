...
public interface Scope {
  ...
  /**
   * @return the scope in which the module path of {@param command} is resolved.
   */
  default @Nullable Scope forNamespaceCommand(@NotNull ConcreteNamespaceCommand command) {
