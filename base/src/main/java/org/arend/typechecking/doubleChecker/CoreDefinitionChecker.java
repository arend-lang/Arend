...
public class CoreDefinitionChecker extends BaseDefinitionTypechecker {
  ...
  private static final class LenientEquations implements Equations {
    ...
    @Override public boolean addEquation(org.arend.core.sort.SortExpression sort1, org.arend.core.sort.SortExpression sort2, CMP cmp, Concrete.SourceNode sourceNode) { return true; }
    @Override public boolean addVariable(org.arend.core.context.binding.inference.InferenceLevelVariable var) { return false; }
    @Override public boolean isUniverseVariable(org.arend.core.context.binding.inference.InferenceVariable var) { return false; }
