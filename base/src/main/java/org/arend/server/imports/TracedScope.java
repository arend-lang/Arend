 ...
 */
interface TracedScope extends Scope {
  /**
   ...
   */
  record Entry(@Nullable Referable referable, @Nullable Scope scope, NamespaceCommandUsage.@Nullable Part part) {}

  @NotNull Map<String, Entry> getEntries(@NotNull ScopeContext context);
}
