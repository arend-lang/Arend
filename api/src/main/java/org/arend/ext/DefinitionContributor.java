...
public interface DefinitionContributor {
   ...
   */
  void declare(@NotNull MetaRef metaRef, @Nullable MetaDefinition meta, @Nullable MetaResolver resolver);

  default void declare(@NotNull MetaRef metaRef, @Nullable MetaDefinition meta) {
    declare(metaRef, meta, meta instanceof MetaResolver ? (MetaResolver) meta : meta instanceof DeferredMetaDefinition defMeta && defMeta.deferredMeta instanceof MetaResolver ? (MetaResolver) defMeta.deferredMeta : null);
  }
}
