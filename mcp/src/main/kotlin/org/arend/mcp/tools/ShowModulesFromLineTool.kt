...
open class ShowModulesFromLineTool(private val server: ArendServer? = null) : McpTool {
  ...
  override fun execute(arguments: String): String {
    ...
    if (fileContent.startsWith("Error:")) {
        for (lib in srv.getLibraries()) {
            ...
            val depContent = outputFile(ModuleLocation(lib, ModuleLocation.LocationKind.SOURCE, path))
